...
class IndiaGeoHelper
{
    public static function states(): array
    {
        return array_keys(self::districtMap());
    }

    public static function districts(string $state): array
    {
        return self::districtMap()[$state] ?? [];
    }

    public static function districtMap(): array
    {
        return [
